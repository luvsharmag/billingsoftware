...
export default function NewInvoicePage() {
  ...
  return (
    <div className='flex flex-col w-full h-full px-5 bg-blue-gray-50 '>

      <div className='flex flex-col border border-gray-400 bg-white p-3 mt-2 overflow-hidden'>
      ...
      <div className='border border-gray-400 bg-white border-t-0 p-3 overflow-hidden'>
      ...
      <div className='flex flex-1 my-2 h-full '>
      ...
      <div className='flex w-full flex-row'>
        <div className=''>
          ...
          <div className='flex items-center'>
            <div className='mr-7'><Checkbox label="Add Shipping and Packaging Costs" /></div>
            <div><input className='border border-gray-600 w-32 mx-2' /></div>
          </div>
        </div>
